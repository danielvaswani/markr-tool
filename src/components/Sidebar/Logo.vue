<template>
    <div class="logo">
        <router-link :to="'/stuurmen' + '/' + 'gallery' ">
            <span>
                <img src="../../assets/images/Markr_w.png" alt="logo" />
            </span>
        </router-link>
        <div v-if="$props.showText && $route.params.bgsName !== undefined" class="edit-logo">
...
.edit-logo {
 ...
 .edit-logo .edit-logo-icon {
    color: #888 !important;
    font-size: 1.3em;
}

.edit-logo .edit-logo-icon:hover {
