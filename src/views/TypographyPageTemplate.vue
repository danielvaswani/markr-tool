<template>
    <div class="container_logo">
        <div class="logos" id="template_div">
            <TitlePage :name="$props.pageName">TYPOGRAPHY</TitlePage>

            <!-- <Container v-for="asset in assets" :key="asset" :name="asset.name" :content="asset.content"
                :type="asset.type">
            </Container> -->
...
import ParagraphAsset from "../components/BgsGallery/ParagraphAsset.vue";
